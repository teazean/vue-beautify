...
<div class="container-fluid tpl-list-ctn">
  ...
  <div class="tpl-header clearfix">
    ...
    <div class="pull-right title-search-ctn">
     
    </div>

    <ul class="filter-nav nav nav-pills nav-sm pull-right">
    </ul>
...
<script>
import Tpl from './tpl';
import {status, statusDesc} from '../store/constants';

import { getUser, getTpls } from '../store/actions'
